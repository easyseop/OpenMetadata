 ...
 */
/**
 * This schema defines the InstanceCode entity. An InstanceCode is a common/reference code
 * entry, identified by a code group and code value, used as shared master data across the
 * platform.
 */
export interface InstanceCode {
    /**
     * Whether this code is currently active/usable.
     */
    active?: boolean;
    /**
    ...
    /**
     * Group/category this code belongs to (e.g. 'COUNTRY', 'STATUS').
     */
    codeGroup: string;
    /**
     * Human readable label for the code group (e.g. '가감구분코드').
     */
    codeGroupName?: string;
    /**
     * Human readable label for this code value.
     */
    codeName?: string;
    /**
     * The code value within the code group (e.g. 'KR', 'ACTIVE').
     */
    codeValue: string;
    /**
    ...
    deleted?: boolean;
    /**
     * Description of this InstanceCode instance.
     */
    description?: string;
    /**
    ...
    displayName?: string;
    /**
     * Domains the InstanceCode belongs to.
     */
    domains?: EntityReference[];
    /**
     * Status of the InstanceCode.
     */
    ...
    /**
     * A unique name that identifies an InstanceCode.
     */
    fullyQualifiedName?: string;
    /**
     * Link to the resource corresponding to this InstanceCode.
     */
    href?: string;
    /**
     * Unique identifier that identifies this InstanceCode instance.
     */
    id: string;
    /**
    ...
    /**
     * Name that identifies this InstanceCode instance uniquely.
     */
    name: string;
    /**
     * Owners of this InstanceCode.
     */
    owners?: EntityReference[];
    /**
     * Registration date of this code (e.g. '20100201').
     */
    registeredDate?: string;
    /**
     * Display sort order of this code within its code group.
     */
    sortOrder?: number;
    /**
     * Tags associated with this InstanceCode.
     */
    tags?: TagLabel[];
    /**
