...
import org.openmetadata.service.search.indexes.InstanceCodeIndex;
...
import org.openmetadata.service.search.indexes.QueryReportIndex;
...
public class SearchIndexFactory {
  ...
  public SearchIndex buildIndex(String entityType, Object entity) {
    return switch (entityType) {
      ...
      case Entity.INSTANCE_CODE -> new InstanceCodeIndex((InstanceCode) entity);
      case Entity.QUERY_REPORT -> new QueryReportIndex((QueryReport) entity);
